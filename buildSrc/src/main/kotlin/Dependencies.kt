...
object Libraries {
    ...
    const val toolingAndSupport = "androidx.compose.ui:ui-tooling:${Versions.compose}"
    const val composeViewModels = "androidx.lifecycle:lifecycle-viewmodel-compose:2.4.1"
    const val composeUiTests = "androidx.compose.ui:ui-test-junit4:${Versions.compose}"
}
